"""
CS 4310 Homework 4 Programming
...
if __name__ == '__main__':
    ...
    p3_1 = []
    for (x,y) in index:
        p3_1.append(pcloud[y, x, :])
    p3_1 = np.array(p3_1).T
    ...
    p3_1_hom = np.vstack((p3_1, np.ones((1, p3_1.shape[1]))))
    p3_2_hom = RT2 @ RT1_inv @ p3_1_hom
    p3_2 = p3_2_hom[0:3, :]
    ...
    p2_h = intrinsic_matrix @ p3_2
    x2d = p2_h[0:2, :] / p2_h[2, :][np.newaxis, :]
