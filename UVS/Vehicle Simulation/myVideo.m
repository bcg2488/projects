function []=myVideo(xActEst,yActEst,thetaAct,X_array,Y_array,rp1,rp2)
% Based in the code by Atilla Dogan
% XX4378/XX5378 - Intro to UVS - Fall 2019

v = VideoWriter('UGV01.avi');
v.FrameRate=40;
open(v);
